...
public class mr990Driver {
    ...
    // 返回：0-成功，其它-失败
    public static int zzLightControl(int lightState, int lightType) {
        int lRV = -1;
        if (lightType == 0) {
    ...
    // 参数：State		-- 1 开   0 关
    // 返回：0-成功，其它-失败
    public static int zzUSBControl(int State) {
    ...
    // 参数：State		-- 1 打开  0 关闭
    // 返回：0-成功，其它-失败
    public static int zzEthernetControl(int State) {
        int lRV = -1;
        lRV = usbControl(0);
        if (lRV != 0) {
            return lRV;
    ...
    // 参数：State		-- 1 打开  0 关闭
    // 返回：0-成功，其它-失败
    public static int zzRelayControl(int State) {
